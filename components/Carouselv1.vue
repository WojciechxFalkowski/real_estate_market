<template>
  <!-- TODO: Pierwsza wersja karuzeli - prawdopodobnie do kasacji po akceptacji przez klienta -->
  <div class="relative">
    <!-- Carousel wrapper -->
    <div class="overflow-hidden relative h-500">
      <!-- Item 1 -->
...
onMounted(() => {
  console.log("props.slide", props.slide);
  if (props.slide) {
    automaticSlide();
  }
});
